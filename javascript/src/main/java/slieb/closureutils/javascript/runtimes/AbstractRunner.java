...
public abstract class AbstractRunner implements RunnerInterface {
    ...
    @Nullable
    public Object evaluateClassResource(@Nonnull final String path)
            throws IOException {
    ...
    @Override
    @Nullable
    public Object evaluateResource(@Nonnull final Resource resource) throws
            IOException {
        try (Reader reader = resource.getReader()) {
            return evaluateReader(reader, resource.getUri().getPath());
        }
    }
