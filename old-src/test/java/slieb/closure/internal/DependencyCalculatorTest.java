...
public class DependencyCalculatorTest {
    ...
    public void testBaseDependencyCalculator() throws Exception {
        ...
        Assert.assertTrue(results.indexOf(dependencyB) < results.indexOf
                (dependencyC));
        Assert.assertTrue(results.indexOf(dependencyA) < results.indexOf
                (dependencyD));
        Assert.assertTrue(results.indexOf(dependencyB) < results.indexOf
                (dependencyD));
        Assert.assertTrue(results.indexOf(dependencyC) < results.indexOf
                (dependencyE));
        Assert.assertTrue(results.indexOf(dependencyD) < results.indexOf
                (dependencyE));
